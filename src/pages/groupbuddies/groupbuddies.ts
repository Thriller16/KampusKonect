...
export class GroupbuddiesPage{
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public requestservice: RequestsProvider, public events: Events, public groupsservice: GroupsProvider) {
  }
  ...
  searchuser(searchbar){
    let tempfriends = this.myfriends;
  ...
  addbuddy(buddy){
    this.newbuddy = buddy;
    this.groupsservice.addmember(buddy);
  }
}
